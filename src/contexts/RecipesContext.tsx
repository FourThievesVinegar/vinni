...
interface RecipesContextType {
  ...
  createRecipe: (title: string, recipeData: object) => string
...
export const RECIPE_EDITOR_DOMAIN = 'https://recipe-press.fourthievesvinegar.org/'
...
const RecipesContext = createContext<RecipesContextType>({
  ...
  closeRecipeEditor: () => {},
  createRecipe: (title: string, recipeData: object) => '',
  editingRecipe: null,
...
export const RecipesProvider = ({ children }: any) => {
  ...
  const createRecipe = (title: string, recipeData: object = {}) => {
    const recipeId = nanoid(12)
    const newRecipe = { title, ...recipeData }
